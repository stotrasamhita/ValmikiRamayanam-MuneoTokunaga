...
MALAYALAM = 'malayalam'
TAMILGRANTHA = 'tamilgrantha'

#: Internal name of Oriya.
ORIYA = 'oriya'

#: Internal name of Sharada.
SHARADA = 'sharada'
...
def _setup():
  ...
  SCHEMES.update({
    BENGALI: Scheme({
      'vowels': s("""অ আ ই ঈ উ ঊ ঋ ৠ ঌ ৡ এ এ ঐ ও ও ঔ"""),
      'marks': s("""া ি ী ু ূ ৃ ৄ ৢ ৣ ে ে ৈ ো ো ৌ"""),
      'virama': s('্'),
      'other': s('ং ঃ ঁ'),
      'consonants': s("""
                            ক খ গ ঘ ঙ
    ...
    SHARADA: Scheme({
      'vowels': s("""𑆃 𑆄 𑆅 𑆆 𑆇 𑆈 𑆉 𑆊 𑆋 𑆌 𑆍𑇌 𑆍 𑆎 𑆏𑇌 𑆏 𑆐"""),
      'marks': s("""𑆳 𑆴 𑆵 𑆶 𑆷 𑆸 𑆹 𑆺 𑆻 𑆼𑇌 𑆼 𑆽 𑆾𑇌 𑆾 𑆿"""),
      'virama': s('𑇀'),
      'other': s('𑆁 𑆂 𑆀'),
      'consonants': s("""
                            𑆑 𑆒 𑆓 𑆔 𑆕
    ...
    GRANTHA: Scheme({
      ...
      'marks': s("""𑌾 𑌿 𑍀 𑍁 𑍂 𑍃 𑍄 𑍢 𑍣 𑍇𑌀 𑍇 𑍈 𑍋𑌀 𑍋 𑍗"""),
      'virama': s('𑍍'),
      'other': s('𑌂 𑌃 𑌁'),
      'consonants': s("""
                            𑌕 𑌖 𑌗 𑌘 𑌙
    ...
    GUJARATI: Scheme({
      'vowels': s("""અ આ ઇ ઈ ઉ ઊ ઋ ૠ ઌ ૡ એ એ ઐ ઓ ઓ ઔ"""),
      'marks': s("""ા િ ી ુ ૂ ૃ ૄ ૢ ૣ ે ે ૈ ો ો ૌ"""),
      'virama': s('્'),
      'other': s('ં ઃ ઁ'),
      'consonants': s("""
                            ક ખ ગ ઘ ઙ
    ...
    MALAYALAM: Scheme({
      ...
      'marks': s("""ാ ി ീ ു ൂ ൃ ൄ ൢ ൣ െ േ ൈ ൊ ോ ൗ"""),
      'virama': s('്'),
      'other': s('ം ഃ ഁ'),
      'consonants': s("""
                            ക ഖ ഗ ഘ ങ
    ...
    ORIYA: Scheme({
      'vowels': s("""ଅ ଆ ଇ ଈ ଉ ଊ ଋ ୠ ଌ ୡ ଏ˘ ଏ ଐ ଓ˘ ଓ ଔ"""),
      'marks': s("""ା ି ୀ ୁ ୂ ୃ ୄ ୢ ୣ େ˘ େ ୈ ୋ˘ ୋ ୌ"""),
      'virama': s('୍'),
      'other': s('ଂ ଃ ଁ'),
      'consonants': s("""
                            କ ଖ ଗ ଘ ଙ
    ...
    TAMIL: Scheme({
      ...
      'other': s("ம்' : ँ"),
      'consonants': s("""
                            க க\\textsuperscript{2} க\\textsuperscript{3} க\\textsuperscript{4} ங
                            ச ச\\textsuperscript{2} ஜ ஜ\\textsuperscript{2} ஞ
                            ட ட\\textsuperscript{2} ட\\textsuperscript{3} ட\\textsuperscript{4} ண
                            த த\\textsuperscript{2} த\\textsuperscript{3} த\\textsuperscript{4} ந
                            ப ப\\textsuperscript{2} ப\\textsuperscript{3} ப\\textsuperscript{4} ம
                            ய ர ல வ
                            ஶ ஷ ஸ ஹ
                            ள க்ஷ ஜ்ஞ
                            ன ற ழ 
